...
export function deepEqual(object1, object2) {
    ...
    switch (type) {
        case "function": {
            return (object1Value.name === object2Value.name &&
        ...
        case "object": {
            ...
            if (Array.isArray(object1Value)) {
                if (object1Value.length !== object2Value.length)
                    return false;
                return !object1Value.find((value, index) => !deepEqual(value, object2Value[index]));
            }
            if (Object.keys(object1Value).length !== Object.keys(object2Value).length)
                return false;
            for (const key in { ...object1Value, ...object2Value }) {
                if (!deepEqual(object1Value[key], object2Value[key]))
                    return false;
            }
            return true;
        }
