...
export class ObservableFromEventListener<const T extends EventTarget, K extends keyof EventsMap<T>> extends Observable<EventsMap<T>[K]> {
  constructor(obj: T, key: K) {
    super()
    obj.addEventListener(key, this.notify)
  }
}