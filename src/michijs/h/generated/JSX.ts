...
animateMotion: Tag<SVGElementTagNameMap["animateMotion"], SVGElements["animateMotion"]>;
animateTransform: Tag<SVGElementTagNameMap["animateTransform"], SVGElements["animateTransform"]>;
...
blockquote: Tag<HTMLElementTagNameMap["blockquote"], HTMLElements["blockquote"]>;
...
colgroup: Tag<HTMLElementTagNameMap["colgroup"], HTMLElements["colgroup"]>;
datalist: Tag<HTMLElementTagNameMap["datalist"], HTMLElements["datalist"]>;
...
feColorMatrix: Tag<SVGElementTagNameMap["feColorMatrix"], SVGElements["feColorMatrix"]>;
feComponentTransfer: Tag<SVGElementTagNameMap["feComponentTransfer"], SVGElements["feComponentTransfer"]>;
feComposite: Tag<SVGElementTagNameMap["feComposite"], SVGElements["feComposite"]>;
feConvolveMatrix: Tag<SVGElementTagNameMap["feConvolveMatrix"], SVGElements["feConvolveMatrix"]>;
feDiffuseLighting: Tag<SVGElementTagNameMap["feDiffuseLighting"], SVGElements["feDiffuseLighting"]>;
feDisplacementMap: Tag<SVGElementTagNameMap["feDisplacementMap"], SVGElements["feDisplacementMap"]>;
feDistantLight: Tag<SVGElementTagNameMap["feDistantLight"], SVGElements["feDistantLight"]>;
feDropShadow: Tag<SVGElementTagNameMap["feDropShadow"], SVGElements["feDropShadow"]>;
...
feGaussianBlur: Tag<SVGElementTagNameMap["feGaussianBlur"], SVGElements["feGaussianBlur"]>;
feImage: Tag<SVGElementTagNameMap["feImage"], SVGElements["feImage"]>;
feMerge: Tag<SVGElementTagNameMap["feMerge"], SVGElements["feMerge"]>;
feMergeNode: Tag<SVGElementTagNameMap["feMergeNode"], SVGElements["feMergeNode"]>;
feMorphology: Tag<SVGElementTagNameMap["feMorphology"], SVGElements["feMorphology"]>;
feOffset: Tag<SVGElementTagNameMap["feOffset"], SVGElements["feOffset"]>;
fePointLight: Tag<SVGElementTagNameMap["fePointLight"], SVGElements["fePointLight"]>;
feSpecularLighting: Tag<SVGElementTagNameMap["feSpecularLighting"], SVGElements["feSpecularLighting"]>;
feSpotLight: Tag<SVGElementTagNameMap["feSpotLight"], SVGElements["feSpotLight"]>;
feTile: Tag<SVGElementTagNameMap["feTile"], SVGElements["feTile"]>;
feTurbulence: Tag<SVGElementTagNameMap["feTurbulence"], SVGElements["feTurbulence"]>;
fieldset: Tag<HTMLElementTagNameMap["fieldset"], HTMLElements["fieldset"]>;
figcaption: Tag<HTMLElementTagNameMap["figcaption"], HTMLElements["figcaption"]>;
...
foreignObject: Tag<SVGElementTagNameMap["foreignObject"], SVGElements["foreignObject"]>;
...
linearGradient: Tag<SVGElementTagNameMap["linearGradient"], SVGElements["linearGradient"]>;
...
noscript: Tag<HTMLElementTagNameMap["noscript"], HTMLElements["noscript"]>;
object: Tag<HTMLElementTagNameMap["object"], HTMLElements["object"]>;
ol: Tag<HTMLElementTagNameMap["ol"], HTMLElements["ol"]>;
optgroup: Tag<HTMLElementTagNameMap["optgroup"], HTMLElements["optgroup"]>;
...
progress: Tag<HTMLElementTagNameMap["progress"], HTMLElements["progress"]>;
q: Tag<HTMLElementTagNameMap["q"], HTMLElements["q"]>;
radialGradient: Tag<SVGElementTagNameMap["radialGradient"], SVGElements["radialGradient"]>;
...
script: Tag<HTMLElementTagNameMap["script"], HTMLElements["script"]> & Tag<SVGElementTagNameMap["script"], SVGElements["script"]>;
...
style: Tag<HTMLElementTagNameMap["style"], HTMLElements["style"]> & Tag<SVGElementTagNameMap["style"], SVGElements["style"]>;
...
template: Tag<HTMLElementTagNameMap["template"], HTMLElements["template"]>;
text: Tag<SVGElementTagNameMap["text"], SVGElements["text"]>;
textPath: Tag<SVGElementTagNameMap["textPath"], SVGElements["textPath"]>;
textarea: Tag<HTMLElementTagNameMap["textarea"], HTMLElements["textarea"]>;
...
title: Tag<HTMLElementTagNameMap["title"], HTMLElements["title"]> & Tag<SVGElementTagNameMap["title"], SVGElements["title"]>;
