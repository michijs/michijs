...
export function List<Y, T extends string = typeof ListElement.tag>({ as, data, renderItem, ...attrs }: ListAttrs<Y, T>, self?: MichiCustomElement) {
  ...
  return h.createElement(as ?? ListElement.tag, {
    ...
    $onupdate: (_jsx, el: Element, isSVG?: boolean, context?: MichiCustomElement) => {
