...
import { AsyncRoute, CreateRouteResult, SyncRoute } from './types';

export function createRoute<SearchParams extends { [key: string]: any; } = undefined, Hash extends `#${string}` | '' = undefined>(route: SyncRoute): CreateRouteResult<SearchParams, Hash> {
