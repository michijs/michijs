...
export type GetSearchParams<S extends SearchParams> = S extends {}
  ...
  : undefined;
export type GetHash<H extends Hash> = H extends {}
  ? {
      [k in H[number]]: boolean;
    }
  : undefined;

export type PagesFunction<
  S extends SearchParams = undefined,
  H extends Hash = undefined,
> = FC<{ searchParams: GetSearchParams<S>; hash: GetHash<H> }>;
export type UrlFunction<
  S extends SearchParams = undefined,
  H extends Hash = undefined,
> = (searchParamsAndHash?: {
  searchParams?: GetSearchParams<S>;
  hash?: keyof GetHash<H>;
}) => URL;
