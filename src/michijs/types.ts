...
export interface UseComputedObservePrimitiveOptions extends UseComputedObserveSharedOptions {
  usePrimitive: true
}
export interface UseComputedObserveOptions extends UseComputedObserveSharedOptions {
  usePrimitive?: false
}
