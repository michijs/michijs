import { AttributesType, EmptyObject, EventsType, KebabCase, MethodsType, MichiElementProperties, Self, SubscribeToType, CssVariablesType, ReflectedAttributesType, ReflectedCssVariablesType, ComputedCssVariablesType } from '../types';
...
export function createElementProperties<
    ...
    >(elementProperties: MichiElementProperties<M, T, E, S, A, RA, NOA, FRA, FOA, EL, never, C, RC, FRC, CC> & ThisType<Self<CC, RC, C, M, T, E, A, RA, NOA, EL, FRA, undefined>> = {}) {
