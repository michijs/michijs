...
export const customObjectHas: CommonObjectProxyHandler<any>["has"] = (target, property) => {
  return (customObjectOwnKeys(target) as Array<string | symbol>).includes(property);
}
