...
import type { Observable } from "../../domain/reactive/Observable";
import type {
  HTMLElements,
  CSSProperties,
  GlobalEvents,
} from "../generated/htmlType";
import type { SearchParams } from "../../domain/routing/types";

// Import JSX types
import "../generated/JSX";
...
// Minimal NavigateEvent for compatibility
