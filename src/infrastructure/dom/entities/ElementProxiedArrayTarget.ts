...
/**
 * Full-featured DOM target for ProxiedArray rendering.
 * Extends the lightweight ElementArrayTarget with all TargetPort methods
 * (pop, shift, reverse, splice, fill, prependItems, insertItemsAt, insertChildNodesAt).
 *
 * Used by the List component when rendering reactive (proxied) arrays.
 */
