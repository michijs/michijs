...
class AuxiliarAllDomAttributes implements AllAttributes {
    ...
    'aria-atomic': boolean | 'false' | 'true' = false;
    'aria-autocomplete': 'none' | 'inline' | 'list' | 'both' = 'none';
    'aria-busy': boolean | 'false' | 'true' = 'false';
    'aria-checked': boolean | 'false' | 'mixed' | 'true' = 'false';
    'aria-colcount': number = 0;
    'aria-colindex': number = 0;
    'aria-colspan': number = 0;
    'aria-controls': string = '';
    'aria-current': boolean | 'false' | 'true' | 'page' | 'step' | 'location' | 'date' | 'time' = 'false';
    'aria-describedby': string = '';
    'aria-details': string = '';
    'aria-disabled': boolean | 'false' | 'true' = 'false';
    'aria-dropeffect': 'none' | 'copy' | 'execute' | 'link' | 'move' | 'popup' = 'none';
    'aria-errormessage': string = '';
    'aria-expanded': boolean | 'false' | 'true' = 'false';
    'aria-flowto': string = '';
    'aria-grabbed': boolean | 'false' | 'true' = 'false';
    'aria-haspopup': boolean | 'false' | 'true' | 'menu' | 'listbox' | 'tree' | 'grid' | 'dialog' = 'false';
    'aria-hidden': boolean | 'false' | 'true' = 'false';
    'aria-invalid': boolean | 'false' | 'true' | 'grammar' | 'spelling' = 'false';
    'aria-keyshortcuts': string = '';
    'aria-label': string = '';
    'aria-labelledby': string = '';
    'aria-level': number = 0;
    'aria-live': 'off' | 'assertive' | 'polite' = 'off';
    'aria-modal': boolean | 'false' | 'true' = 'false';
    'aria-multiline': boolean | 'false' | 'true' = 'false';
    'aria-multiselectable': boolean | 'false' | 'true' = 'false';
    'aria-orientation': 'horizontal' | 'vertical' = 'horizontal';
    'aria-owns': string = '';
    'aria-placeholder': string = '';
    'aria-posinset': number = 0;
    'aria-pressed': boolean | 'false' | 'mixed' | 'true' = 'false';
    'aria-readonly': boolean | 'false' | 'true' = 'false';
    'aria-relevant': 'additions' | 'additions text' | 'all' | 'removals' | 'text' = 'all';
    'aria-required': boolean | 'false' | 'true' = 'false';
    'aria-roledescription': string = '';
    'aria-rowcount': number = 0;
    'aria-rowindex': number = 0;
    'aria-rowspan': number = 0;
    'aria-selected': boolean | 'false' | 'true' = 'false';
    'aria-setsize': number = 0;
    'aria-sort': 'none' | 'ascending' | 'descending' | 'other' = 'none';
    'aria-valuemax': number = 0;
