import { As, Autocapitalize, Autocomplete, Capture, Charset, Crossorigin, CSSProperties, Decoding, Dir, Enctype, EnterKeyHint, HTTPEquiv, InputMode, Kind, Language, Loading, Method, MonthString, Preload, Rel, Sandbox, Scope, Shape, StringBoolean, Target, Wrap, YesNo } from "./types";
