import type { ElementFactoryType, FC, VirtualFragmentPort, NonProxiedArrayTargetPort } from "../ports";


export class NonProxiedArrayTarget<V> implements NonProxiedArrayTargetPort<V, Node> {
